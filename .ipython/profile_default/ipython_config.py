...
#c.InteractiveShell.banner1 = "Python 3.5.5 (default, Feb  4 2018, 23:53:42) \nType 'copyright', 'credits' or 'license' for more information\nIPython 6.2.1 -- An enhanced Interactive Python. Type '?' for help.\n"
...
#         highlighting: 
#  paraiso-light, algol_nu, manni, vs, friendly, autumn, arduino, vim, pastie, igor, bw, abap, perldoc, emacs, rainbow_dash, borland, native, murphy, lovelace, trac, fruity, algol, colorful, default, xcode, monokai, paraiso-dark, tango, rrt
